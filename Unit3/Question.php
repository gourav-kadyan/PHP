...
<body>
   ...
   <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && empty($nameErr) && empty($emailErr) && empty($mobileErr) && empty($usernameErr)) {
        echo "<h3>Submitted Information:</h3>";
        echo "Name: " . $name . "<br>";
        echo "Email: " . $email . "<br>";
        echo "Mobile Number: " . $mobile . "<br>";
        echo "Username: " . $username . "<br>";
        // For security reasons, it's not recommended to display the password.
    }
    ?>
</body>
</html>
